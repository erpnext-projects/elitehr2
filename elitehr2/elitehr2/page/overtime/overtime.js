frappe.pages['overtime'].on_page_load = function(wrapper) {
    ...
    $(`<span>${__("Managing and recording overtime work requests and hours")}</span><br>`).appendTo(wrapperContent);
